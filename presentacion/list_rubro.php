...
?>
<?php
require("xajax_rubro.php");
require("headerNew.php");
$_SESSION['linkactivo']='CONVOCATORIAS';
require("menu.php");
?>
<div class="art-post-inner art-article">
<h2 class="art-postheader"><span class="art-postheadericon"></span>RUBROS</h2>
...
<tr>
<td width="764">
<form action="mant_rubro.php?accion=NUEVO&IdPerfil=<?php echo $_GET['IdPerfil'];?>" method="POST">
...
<table width="730" border="0" class="tablaint">
  <tr>
    <td width="104">DESCRIPCION</td>
    <td width="146"><input name="txtDescripcion" type="text" id="txtDescripcion"></td>
    <td width="72"><input type="button" name="Submit" value="BUSCAR" onClick="listarrubros()"></td>
